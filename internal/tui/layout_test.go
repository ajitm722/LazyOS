...
func TestComputePaneBounds(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want: paneBounds{leftWidth: 26, leftHeight: 45, viewWidth: 66, viewHeight: 35, queryHeight: 5},
		},
		{
			...
			want: paneBounds{leftWidth: 0, leftHeight: 5, viewWidth: 3, viewHeight: 3, queryHeight: 0},
		},
		{
		...
		},
		{
			...
			want: paneBounds{leftWidth: 20, leftHeight: 19, viewWidth: 52, viewHeight: 14, queryHeight: 0},
		},
		{
			...
			want: paneBounds{leftWidth: 20, leftHeight: 25, viewWidth: 52, viewHeight: 19, queryHeight: 1},
		},
		{
